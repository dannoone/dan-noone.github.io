...
format: 
  html:
    ...
    code-fold: false       # https://quarto.org/docs/output-formats/html-code.html, #Will make it so you can click to see code, if put show will give option
    code-tools: true
    code-link: true
...
use_condaenv("C:\\Users\\Dan\\anaconda3", required = TRUE)
```
# Python Basics
